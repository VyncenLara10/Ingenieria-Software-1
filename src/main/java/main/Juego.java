...
import database.Settings; // 👈 nuevo import
...
public class Juego implements Runnable {
    ...
    // 🟢 NUEVO: configuración del jugador
    ...
    public Juego() {
        this(new Settings("Default", 0.8f, 1.0f)); // usa valores por defecto
    }

    // 🟢 Nuevo constructor que recibe configuración del jugador
    public Juego(Settings settings) {
        this.settings = settings;
        System.out.println("🌟 Configuración cargada: brillo=" + settings.getBrightness() +
                           ", velocidad=" + settings.getSpeed());
    ...
    // 🟢 Nuevo getter para acceder a los ajustes desde otras clases

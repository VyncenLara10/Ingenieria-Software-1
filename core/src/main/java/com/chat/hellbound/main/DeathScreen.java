...
public class DeathScreen implements Screen {
    ...
    private final Color bg = new Color(0.07f, 0.06f, 0.08f, 1f);
    private final Color title = new Color(0.95f, 0.1f, 0.1f, 1f);
    private final Color subtitle = new Color(0.88f, 0.88f, 0.93f, 1f);
    ...
    public void render(float delta) {
        ...
        sr.rect(0, 0, Constants.WORLD_WIDTH, Constants.WORLD_HEIGHT * 0.18f);
        sr.rect(0, Constants.WORLD_HEIGHT * 0.82f, Constants.WORLD_WIDTH, Constants.WORLD_HEIGHT * 0.18f);
        sr.end();

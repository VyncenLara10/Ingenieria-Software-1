...
public class Constants {
    ...
    public static class TreeBossConstants {
        ...
        public static final int   ANI_SPEED        = 6;
        public static final int   MAX_HP           = 150;  // Mucha más vida
        public static final int   DAMAGE           = 2;    // Más daño
        public static final float MOVE_SPEED       = 140f; // Un poco más rápido
